...
const navigation = [
  ...
  { to: ROUTES.COMPLAINTS, label: 'Şikayetler', icon: '📣' },
]
        ...
        <aside className="mini-rail relative z-10 border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 lg:sticky lg:top-16 lg:h-[calc(100vh-4rem)] lg:overflow-auto">
          <div className="flex h-full flex-col">
            <div className="flex items-center gap-3 px-3 py-4">
              <div className="h-8 w-8 rounded-md bg-brand-600 text-white grid place-items-center font-semibold">K</div>
              <div className="hidden pl-2 text-sm font-semibold text-slate-900 dark:text-white lg:block">Kurumsal</div>
            </div>
            ...
            <div className="mt-auto px-3 py-6">
              <div className="hidden lg:block text-xs text-slate-600 dark:text-slate-300">Kurumsal araçlar</div>
            </div>
          </div>

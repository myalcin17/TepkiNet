...
if (companyLoading) {
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Şirket bilgilerinizi ve ayarlarınızı görüntüleyin."
      />
        ...
        <main className="space-y-6">
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
              Şirketinizle ilgili temel bilgileri burada görebilirsiniz.
            </p>
  ...
  <dd className="text-lg text-slate-900 dark:text-slate-100">
    {company?.companyName || 'Belirtilmedi'}
  </dd>
</div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <dd className="text-lg text-slate-900 dark:text-slate-100">
                  {company?.supportEmail || user?.email || 'Belirtilmedi'}
                </dd>
              </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <dl className="mt-4 space-y-3 text-sm">
              ...
              <div>
                ...
                <dd className="text-slate-600 dark:text-slate-400">Kurumsal Hesap</dd>
              </div>
            </dl>
          </section>
        </aside>
